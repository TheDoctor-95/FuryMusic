...
public class AlbumResourceIntTest {
    ...
    public void createAlbum() throws Exception {
        ...
        assertThat(testAlbum.getImg()).isEqualTo(DEFAULT_IMG);
        assertThat(testAlbum.getImgContentType()).isEqualTo(DEFAULT_IMG_CONTENT_TYPE);
    }
    ...
    public void updateAlbum() throws Exception {
        ...
        assertThat(testAlbum.getImg()).isEqualTo(UPDATED_IMG);
        assertThat(testAlbum.getImgContentType()).isEqualTo(UPDATED_IMG_CONTENT_TYPE);
    }
